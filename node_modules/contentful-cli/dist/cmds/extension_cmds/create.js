...
exports.createExtensionHandler = createExtensionHandler;
...
async function createExtension(environment, data) {
  ...
  const createPromise = data.id ? environment.createUiExtensionWithId(data.id, extensionData) : environment.createUiExtension(extensionData);
...
async function createExtensionHandler(argv) {
  ...
  await (0, _assertions2.assertExtensionValuesProvided)(data, 'create');
...
const handler = exports.handler = (0, _async.handleAsyncError)(createExtensionHandler);