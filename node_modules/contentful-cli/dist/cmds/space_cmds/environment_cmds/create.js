...
async function environmentCreate(argv) {
  ...
  const environment = argv.source ? await space.createEnvironmentWithId(argv.environmentId, options, argv.source) : await space.createEnvironmentWithId(argv.environmentId, options);
