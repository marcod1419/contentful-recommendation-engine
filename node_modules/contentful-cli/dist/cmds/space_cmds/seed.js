...
async function spaceSeed(argv) {
  ...
  const { cmaToken, host = 'api.contentful.com', proxy, rawProxy } = await (0, _context.getContext)();
  ...
  const content = await _bfj2.default.read((0, _path.resolve)(destination, argv.template, 'contentful-export.json'));
