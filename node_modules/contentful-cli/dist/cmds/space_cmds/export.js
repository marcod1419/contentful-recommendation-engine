...
const exportSpace = exports.exportSpace = async argv => {
  ...
  const { cmaToken, activeSpaceId, activeEnvironmentId, proxy, rawProxy, host = 'api.contentful.com' } = await (0, _context.getContext)();
  ...
  const options = _extends({}, argv, { spaceId, environmentId, managementApplication, managementFeature, managementToken, host });
