...
exports.default = async function devServerStep(guideContext) {
  ...
  (0, _log.log)();
  (0, _log.wrappedLog)(`A browser will open showing your new ${activeGuide.name}. Feel free to make changes to the code and see them appear immediatly.`, _helpers.GUIDE_MAX_WIDTH);
  (0, _log.log)();
    ...
    const opener = data => {
      ...
      if (activeGuide.devBrowserOpenRegex.test(str)) {
        ...
        if (['win32', 'darwin'].includes(process.platform)) {
          (0, _opn2.default)(activeGuide.devURI, {
            wait: false
          });
        } else {
