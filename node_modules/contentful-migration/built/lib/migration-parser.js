...
const validation_1 = require("./migration-chunks/validation");
const content_type_1 = require("./entities/content-type");
const content_type_update_1 = require("./intent-validator/content-type-update");
const field_update_1 = require("./intent-validator/field-update");
const field_movement_1 = require("./intent-validator/field-movement");
const entry_derive_1 = require("./intent-validator/entry-derive");
const content_transform_1 = require("./intent-validator/content-transform");
const intent_list_1 = require("./intent-list");
const errors = require("./errors/index");
const entry_1 = require("./entities/entry");
const fetcher_1 = require("./fetcher");
const offline_api_1 = require("./offline-api");
class ParseResult {
    constructor() {
        this.batches = [];
