...
const duplicate_props_1 = require("./duplicate-props");
const content_type_2 = require("../../entities/content-type");
function validateIntents(intentList, contentTypes) {
    const intents = intentList.getIntents();
    const ctErrors = content_type_1.default(intents, contentTypes);
    ...
    let fieldErrors = field_1.default(intents, allCTs);
    fieldErrors = fieldErrors.concat(duplicate_props_1.default(intentList));
