...
const migration_parser_1 = require("../lib/migration-parser");
const render_migration_1 = require("./lib/render-migration");
const steps_errors_1 = require("./lib/steps-errors");
const write_errors_to_log_1 = require("./lib/write-errors-to-log");
...
const createRun = ({ shouldThrow }) => async function run(argv) {
    ...
    try {
        ...
        console.error(chalk_1.default `{red.bold The ${argv.filePath} script could not be parsed, as it seems to contain syntax errors.}\n`);
        console.error(e);
        return;
    }
    ...
    await render_migration_1.renderPlan(batches, argv.environmentId);
