...
function (_Component) {
  ...
  function TextLink() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TextLink).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(TextLink, [{
    ...
    value: function renderIcon(icon, linkType) {
      ...
      return _react.default.createElement("div", {
        className: styles['TextLink__icon-wrapper']
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["children", "href", "linkType", "testId", "onClick", "disabled", "extraClassNames", "icon", "text"]);
      var classNames = (0, _classnames.default)(styles.TextLink, extraClassNames, (_cn = {}, (0, _defineProperty2.default)(_cn, styles["TextLink--".concat(linkType)], linkType), (0, _defineProperty2.default)(_cn, styles['TextLink--disabled'], disabled), _cn));

      var content = _react.default.createElement(_TabFocusTrap.default, null, this.renderIcon(icon, linkType), text || children);
...
(0, _defineProperty2.default)(TextLink, "propTypes", {
  children: _propTypes.default.node,
  linkType: _propTypes.default.oneOf(['primary', 'positive', 'negative', 'secondary', 'muted']),
...
(0, _defineProperty2.default)(TextLink, "defaultProps", {
  linkType: 'primary',
