...
function (_Component) {
  ...
  function Tab() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onKeyPress", function (e) {
      if (e.key === 'Enter') {
        _this.props.onSelect(_this.props.id);
  ...
  (0, _createClass2.default)(Tab, [{
    ...
    value: function render() {
      ...
      var elementProps = {
        className: (0, _classnames.default)(styles.Tab, (0, _defineProperty2.default)({}, styles['Tab__selected'], selected), extraClassNames),
      ...
      if (href) {
        ...
        return _react.default.createElement("a", elementProps, children);
      } else {
        elementProps['aria-selected'] = selected;
        elementProps['role'] = 'tab';
        elementProps['aria-controls'] = id;
        return _react.default.createElement("div", elementProps, children);
      }
    }
  }]);
  return Tab;
