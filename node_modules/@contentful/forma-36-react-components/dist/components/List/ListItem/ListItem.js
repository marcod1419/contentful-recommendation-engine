...
function (_Component) {
  ...
  (0, _createClass2.default)(ListItem, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames.default)(styles['ListItem'], extraClassNames, (0, _defineProperty2.default)({}, styles['ListItem--nested-list'], this.props.children.type === _List.default));
