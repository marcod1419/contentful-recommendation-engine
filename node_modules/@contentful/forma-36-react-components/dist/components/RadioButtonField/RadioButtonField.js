...
var _ControlledInputField = _interopRequireDefault(require("../ControlledInputField/ControlledInputField"));
...
function (_Component) {
  ...
  function RadioButtonField() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(RadioButtonField).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(RadioButtonField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_ControlledInputField.default, (0, _extends2.default)({
        testId: testId
      }, otherProps, {
        inputType: "radio"
      }));
...
(0, _defineProperty2.default)(RadioButtonField, "defaultProps", {
  labelIsLight: false,
  checked: false,
  inputType: 'checkbox',
