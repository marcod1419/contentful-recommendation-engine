...
function (_Component) {
  ...
  function SkeletonImage() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SkeletonImage).apply(this, arguments));
  }
...
(0, _defineProperty2.default)(SkeletonImage, "propTypes", {
  testId: _propTypes.default.string,
  offsetLeft: _propTypes.default.number,
  offsetTop: _propTypes.default.number,
  width: _propTypes.default.number,
  height: _propTypes.default.number,
  radiusX: _propTypes.default.number,
  radiusY: _propTypes.default.number
});
(0, _defineProperty2.default)(SkeletonImage, "defaultProps", {
