  ...
  (0, _createClass2.default)(Button, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["extraClassNames", "children", "icon", "buttonType", "size", "isFullWidth", "onBlur", "testId", "onClick", "loading", "disabled", "indicateDropdown", "href", "type"]);
      var classNames = (0, _classnames.default)(styles.Button, extraClassNames, styles["Button--".concat(buttonType)], (_cn = {}, (0, _defineProperty2.default)(_cn, styles['Button--disabled'], disabled), (0, _defineProperty2.default)(_cn, styles["Button--".concat(size)], size), (0, _defineProperty2.default)(_cn, styles['Button--full-width'], isFullWidth), _cn));
      ...
      return _react.default.createElement(Element, (0, _extends2.default)({
        ...
        extraClassNames: styles['Button__inner-wrapper']
