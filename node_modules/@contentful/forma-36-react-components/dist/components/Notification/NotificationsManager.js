...
function (_PureComponent) {
  ...
  function NotificationsManager(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(NotificationsManager).call(this, props));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "show", function (text, _ref) {
  ...
  (0, _createClass2.default)(NotificationsManager, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_NotificationItemContainer.default, {
          intent: item.intent,
