...
function (_Component) {
  ...
  function TableSortingLabel() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TableSortingLabel).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(TableSortingLabel, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["extraClassNames", "children", "active"]);
      return _react.default.createElement("button", (0, _extends2.default)({
        type: "button",
        className: (0, _classnames.default)(styles['TableSortingLabel__button'], extraClassNames)
...
(0, _defineProperty2.default)(TableSortingLabel, "propTypes", {
