  ...
  (0, _createClass2.default)(Icon, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["extraClassNames", "icon", "size", "color", "testId"]);
      var classNames = (0, _classnames.default)(styles.Icon, extraClassNames, (_cn = {}, (0, _defineProperty2.default)(_cn, styles["Icon--".concat(size)], size), (0, _defineProperty2.default)(_cn, styles["Icon--".concat(color)], color), (0, _defineProperty2.default)(_cn, styles['Icon--trimmed'], icon.toLowerCase().includes('trimmed')), _cn));
...
(0, _defineProperty2.default)(Icon, "propTypes", {
  ...
  size: _propTypes.default.oneOf(['tiny', 'small', 'large']),
  color: _propTypes.default.oneOf(['primary', 'positive', 'negative', 'secondary', 'muted', 'white']),
