  ...
  (0, _createClass2.default)(DisplayText, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          otherProps = (0, _objectWithoutProperties2.default)(_this$props, ["extraClassNames", "children", "testId", "element", "size"]);
      var classNames = (0, _classnames.default)(styles['DisplayText'], extraClassNames, (0, _defineProperty2.default)({}, styles["DisplayText--".concat(size)], size));
      var Element = element;
...
(0, _defineProperty2.default)(DisplayText, "defaultProps", {
  element: 'h1',
