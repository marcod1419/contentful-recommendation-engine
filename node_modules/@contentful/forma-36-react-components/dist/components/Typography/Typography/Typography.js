...
function (_Component) {
  ...
  (0, _createClass2.default)(Typography, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames.default)(styles.Typography, extraClassNames);
      return _react.default.createElement(TypographyContext.Provider, {
        value: {
          displayText: {
            spacing: 'l'
          },
...
(0, _defineProperty2.default)(Typography, "propTypes", {
  extraClassNames: _propTypes.default.string,
  children: _propTypes.default.node,
  testId: _propTypes.default.string
});
(0, _defineProperty2.default)(Typography, "defaultProps", {
