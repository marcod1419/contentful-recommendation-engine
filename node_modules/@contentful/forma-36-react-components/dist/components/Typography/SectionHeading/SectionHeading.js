...
function (_Component) {
  ...
  (0, _createClass2.default)(SectionHeading, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames.default)(styles['SectionHeading'], extraClassNames);
      var Element = element;
...
(0, _defineProperty2.default)(SectionHeading, "propTypes", {
  extraClassNames: _propTypes.default.string,
  children: _propTypes.default.node,
  testId: _propTypes.default.string,
  element: _propTypes.default.oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p'])
});
(0, _defineProperty2.default)(SectionHeading, "defaultProps", {
  element: 'h3',
